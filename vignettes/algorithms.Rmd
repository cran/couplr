...
couplr implements **20 algorithms** (19 solvers plus automatic selection), including methods that exist in no other R package: Gabow-Tarjan, Orlin-Ahuja, Network Simplex, Ramshaw-Tarjan.
